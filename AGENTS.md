...
`docs/context/operating-memory.md`, `docs/context/slack-session.md`, and any
focused context file relevant to the task. `slack-session.md` is legacy-named
remote session memory; Discord `#codex` is the primary remote control channel.
